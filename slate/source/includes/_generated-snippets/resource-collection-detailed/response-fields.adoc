...
|`+videos+`
|`+Array+`
|A list of <<resources-videos,videos>> in the collection. Shallow video details are returned by default

|`+subjects+`
|`+Array+`
|A list of subjects assigned to this collection. See <<resources-subjects_response_fields,subjects>> for payload details
...
|`+attachments+`
|`+Array+`
|A list of <<resources-collections-attachments,attachments>> linked to this collection
