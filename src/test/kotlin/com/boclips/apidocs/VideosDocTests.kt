        ...
        given(documentationSpec)
                .filter(
                        document(
                                ...
                                //Filters
                                parameterWithName("query").optional().description("The text search query").attributes(Attributes.key("type").value("String")).attributes(Attributes.key("type").value("String")),
