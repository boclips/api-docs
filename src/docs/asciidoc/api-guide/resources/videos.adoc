...
Search facets expose hit counts for specific "buckets", namely *subjects*, *age ranges*, *durations* and *education levels*. Facets can substantially improve the search experience of users.
