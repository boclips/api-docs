...
----
HTTP/1.1 200 OK
X-Boclips-Trace-ID: 5314cbdd818a05b8
Vary: Origin
...
X-Robots-Tag: none
Content-Security-Policy: frame-src 'self' https://*.hubspot.com; frame-ancestors 'self' https://*.boclips.com http://localhost:3000 http://localhost:9000 http://localhost:8081; object-src 'none';
    ...
    <div class="login-pf-page">
        ...
        <div>
            ...
            <form id="kc-form-login"
                  ...
                  action="https://login.boclips.com/realms/boclips/login-actions/authenticate?session_code=Z02b3i_B6h7dI4yD0bx7Hh5p3i1sr2GyV2-EsFGQOqk&amp;execution=71ed839b-d34c-414d-b008-a7e6612fe9ef&amp;client_id=teachers&amp;tab_id=Jb_axTD-A4c"
                  class="boclips-login"
                  method="post"
            >
                    <section>
                    ...
                    <section class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <span>
                                    <a data-qa="forgot-password"
                                       ...
                                       href="/realms/boclips/login-actions/reset-credentials?client_id=teachers&amp;tab_id=Jb_axTD-A4c"
                                    >
                        ...
                        <div id="kc-social-providers" class="boclips-social-container">
                            <ul>
                                    <li>
                                        <a href="/realms/boclips/broker/google/login?client_id=teachers&amp;tab_id=Jb_axTD-A4c&amp;session_code=Z02b3i_B6h7dI4yD0bx7Hh5p3i1sr2GyV2-EsFGQOqk"
                                           id="zocial-google"
                                    ...
                                    <li>
                                        <a href="/realms/boclips/broker/microsoft/login?client_id=teachers&amp;tab_id=Jb_axTD-A4c&amp;session_code=Z02b3i_B6h7dI4yD0bx7Hh5p3i1sr2GyV2-EsFGQOqk"
                                           id="zocial-microsoft"
                                    ...
                                    <li>
                                        <a href="/realms/boclips/broker/moe-uae/login?client_id=teachers&amp;tab_id=Jb_axTD-A4c&amp;session_code=Z02b3i_B6h7dI4yD0bx7Hh5p3i1sr2GyV2-EsFGQOqk"
                                           id="zocial-moe-uae"
                                    ...
                                    <li>
                                        <a href="/realms/boclips/broker/viewsonic/login?client_id=teachers&amp;tab_id=Jb_axTD-A4c&amp;session_code=Z02b3i_B6h7dI4yD0bx7Hh5p3i1sr2GyV2-EsFGQOqk"
                                           id="zocial-viewsonic"
