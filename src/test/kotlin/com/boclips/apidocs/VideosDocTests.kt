            ...
            .filter(
                document(
                    ...
                    , requestParameters(
                        ...
                        parameterWithName("best_for").optional().description("Filter responses by <<resources-tags,tags>>, exact matches when specifying multiple tags").attributes(
                            Attributes.key("type").value("List of strings (then name of the tag)")
                        ),
                        // Sorting
